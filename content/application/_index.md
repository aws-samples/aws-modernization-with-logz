...
Now that we have installed our observability stack we can deploy and application and start putting everything together.
In this section we will deploy the Astronomy shop which also known as the OpenTelemetry Demo.

Please refer to the service legend to understand the language used for each service. As you

![](/images/otel-demo/otel-demo-service-legend.png)
...
![](/images/otel-demo/otel-demo-arch.png)
...
| ------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| .NET          |                                                                                       | [Cart Service](https://opentelemetry.io/docs/demo/https://opentelemetry.io/docs/demo/services/cart/)                                                                                                                                              | [Cart Service](https://opentelemetry.io/docs/demo/https://opentelemetry.io/docs/demo/services/cart/)                                                               |
| C++           |                                                                                       |                                                                                                                                                                                                                                                   | [Currency Service](https://opentelemetry.io/docs/demo/https://opentelemetry.io/docs/demo/services/currency/)                                                       |
| Erlang/Elixir |                                                                                       | [Feature Flag Service](https://opentelemetry.io/docs/demo/https://opentelemetry.io/docs/demo/services/feature-flag/)                                                                                                                              | [Feature Flag Service](https://opentelemetry.io/docs/demo/https://opentelemetry.io/docs/demo/services/feature-flag/)                                               |
